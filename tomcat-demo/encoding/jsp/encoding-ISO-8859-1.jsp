...
<html>
   ...
   <body>
    ...
    <p>Data posted/got to this form was:<pre><%
      ...
      out.println(java.net.URLDecoder.decode(sb.toString(), java.nio.charset.StandardCharsets.UTF_8.name()));
    %></pre>
     </p>
<br/>GET:
     <form method="GET" action="encoding-ISO-8859-1.jsp">
...
<br/>POST:
     <form method="POST" action="encoding-ISO-8859-1.jsp">
